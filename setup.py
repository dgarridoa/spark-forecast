...
from dbx_demand_forecast import __version__
...
setup(
    ...
    entry_points = {
        "console_scripts": [
            "etl = dbx_demand_forecast.tasks.sample_etl_task:entrypoint",
            "ml = dbx_demand_forecast.tasks.sample_ml_task:entrypoint",
    ]},
    version=__version__,
    description="",
    author="",
